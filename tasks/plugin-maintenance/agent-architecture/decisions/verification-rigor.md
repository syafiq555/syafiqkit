...
## How to Verify a Checklist Actually Ran (Not Just Skimmed)
...
## Catching Defects the Model Already Fixed In-Place (Unreported Deviations)
...
## Silent-Pass Exit Conditions: When Empty Input Emits Success
...
## Drift Detection: How to Spot What Changed When Templates Matter
...
## Gates, Modes, and Default Behavior
...
## How Readers Behave, and Where Rules Live
...
## Edge Cases: Non-Git and Empty-State Contexts
...
## Verification Method: When to Check the Rule, Not Just the Output
